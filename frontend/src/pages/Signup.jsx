...
export default function Signup() {
  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative', overflow: 'hidden', background: '#0f172a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
      ...
      <div style={{ position: 'absolute', bottom: '5rem', left: '50%', transform: 'translateX(-50%)', width: '24rem', height: '24rem', background: '#ec4899', borderRadius: '9999px', mixBlendMode: 'multiply', filter: 'blur(64px)', opacity: 0.3, animation: 'pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite', animationDelay: '4s' }}></div>
      ...
      <div style={{ position: 'relative', width: '100%', maxWidth: '28rem', zIndex: 10 }}>
        ...
        {/* Signup card with gradient border */}
        <div style={{ padding: '4px', borderRadius: '1.5rem', background: 'linear-gradient(135deg, rgba(139, 92, 246, 0.5) 0%, rgba(59, 130, 246, 0.5) 50%, rgba(236, 72, 153, 0.5) 100%)' }}>
          <div style={{ padding: '2rem', borderRadius: '1.5rem', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)', background: 'rgba(15, 23, 42, 0.95)' }}>
            <h2 style={{ fontSize: '1.5rem', color: 'white', fontWeight: 'bold', marginBottom: '1.5rem', textAlign: 'center' }}>Create Account</h2>

            <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              {/* Name */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label style={{ fontSize: '0.875rem', color: '#d1d5db', fontWeight: '500' }}>Full Name</label>
                <div style={{ position: 'relative' }}>
                  <div style={{ position: 'absolute', top: 0, bottom: 0, left: 0, paddingLeft: '1rem', display: 'flex', alignItems: 'center', pointerEvents: 'none' }}>
                    <svg style={{ width: '1.25rem', height: '1.25rem', color: '#9ca3af' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A9 9 0 1118.88 6.195M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                  </div>
                  <input
                    type="text"
                    ...
                    onFocus={(e) => {
                      ...
                      e.target.style.boxShadow = '0 0 0 3px rgba(139, 92, 246, 0.06)';
                    }}
                    onBlur={(e) => {
